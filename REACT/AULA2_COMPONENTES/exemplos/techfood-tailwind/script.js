  ...
  */
  card.innerHTML = `
    <div class="p-4 flex flex-col flex-grow">
      ...
      <button class="mt-auto bg-red-600 text-white rounded-lg py-2 px-4 hover:bg-red-700 transition-colors"
...
function abrirModal(btn) {
  const modal = document.getElementById('modalPrato') || document.getElementById('modal');
  if (!modal) return;
  ...
  if (elDescricao) {
    elDescricao.textContent = btn.getAttribute('data-descricao');
  }
...
// Fechar clicando fora do modal (com verificação de segurança)
const modalElement = document.getElementById('modalPrato') || document.getElementById('modal');
if (modalElement) {
